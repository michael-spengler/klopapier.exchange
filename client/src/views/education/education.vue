            ...
            <div class="screen-body-item">
              <div class="app-form">
                <div class="app-form-group">
                    Test your knowledge by downloading this <a download href="https://github.com/kevkre/klopapierFFC"> Fancy Flashcard</a>.
...
;text-align:center;padding:50px 80px;text-align: justify;">
  <h3>ERC-20 Tokens</h3>
  <p class="contentData">ERC-20 tokens represent a large and diverse range of digital assets. Just like other crypto assets they can have a value and be sent or received. The difference between Bitcoin or Ethereum is that an ERC-20 Token does not have it’s on Blockchain. Rather it resides on top of the Ethereum blockchain. These tokens are stored on Ethereum addresses and sent using Ethereum transactions. To be able to send ERC-20 Tokens you will need to use Ethereum Gas (for more information <a href="https://medium.com/coinmonks/ethereum-gas-explained-in-plain-english-d9e60a699c54"> see</a>) . To be able to store ERC-20 tokens you can use a hardware wallet using the ETH application for example.  But you can also use other wallets like <a href="https://www.myetherwallet.com/"> MyEtherWallet </a>  or  <a href="https://www.mycrypto.com/"> MyCrypto </a>.
