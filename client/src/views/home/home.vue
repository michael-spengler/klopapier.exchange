      ...
      >
        ...
        >
          <div class="sm:text-center lg:text-left">
            ...
            >
              <span id="expColor" class="block xl:inline"
                >Exploration Playground</span
              >
            </h1>
            <p
        ...
        <div class="face face2">
          <div class="content">
            <p>
              ...
              Technology which is the basis for currencies like Ether and
              Bitcoin. Please understand some differences between the Bitcoin
              Whitepaper and the USD WipePaper
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="face face2">
          <div class="content">
            <p>
              ...
              Blockchain, we recommend to use the brave.com Browser.
              Alternatively you can use metamask.io For developers we recommend
              the
              <!-- <a
      ...
      <div class="md:grid grid-cols-2 grid-gap-64">
        ...
        <div class="mt-8 md:mt-0">
          ...
          <p>
            ...
            a fair system. In order to foster fair systems we invested time into
            professional incentive engineering. We came to the conclusion that
            Ether, Bitcoin & Co. can play valuable roles in this game. As long
            as private keys are save you cannot spend anything on the Blockchain
            which you do not own. Compare this to our current (January 2021)
            fiat currency system which is fundamentally based on debts. Fed &
            ECB ... giving out loans directly at the beginning. This system,
            combined with the fact that many of our politicians do not perceive
            us (the people) as their employers but rather as their servants,
            seems not to be the best at the moment. After the invention of the
            income tax some of our tax systems became crazy in many countries as
            they did no longer provide reasonable incentives for people for
            creating value for other people. The middle class people had been
            punished for creating value for other people by unfair income taxes.
            Lazy people and super rich people benefitted from this. This lack of
            professional incentive engineering in the past inspired ordinary
            reasonable people to use anonymization patterns like the ones
            supported by
            ...
            >
            had been showing negative interest rates since about 2015. These are
          ...
          <div>
            <p>
              ...
              <a
                ...
                rel="noopener"
                >DHBW Mannheim</a
              >. We are happy about high quality contributions from anyone. We
              want to provide valuable and fun education around decentralized
              incentive engineering and peer to peer collaboration. Along this
